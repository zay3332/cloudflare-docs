...
```txt
wrangler vectorize create <INDEX_NAME> [--dimensions=<NUM_DIMENSIONS>] [--metric=<DISTANCE_METRIC>] [--description=<DESCRIPTION>]
```
...
```txt
wrangler vectorize upsert <INDEX_NAME> [OPTIONS]
```
...
```txt
wrangler vectorize query <INDEX_NAME> [OPTIONS]
```
...
```txt
wrangler vectorize get-vectors <INDEX_NAME> [OPTIONS]
```
...
```txt
wrangler vectorize delete-vectors <INDEX_NAME> [OPTIONS]
```
...
```txt
wrangler vectorize create-metadata-index <INDEX_NAME> [OPTIONS]
```
...
```txt
wrangler vectorize list-metadata-index <INDEX_NAME> [OPTIONS]
```
...
```txt
wrangler vectorize delete-metadata-index <INDEX_NAME> [OPTIONS]
```

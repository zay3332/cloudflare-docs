...
[Add polyfills](/workers/wrangler/configuration/#add-polyfills-using-wrangler) for a subset of Node.js APIs to your Worker by adding the "nodejs_compat_v2" compatability flag to your `wrangler.toml`.

...
Open the `wrangler.toml` file at the root of your `workflows-tutorial` folder:
...
# The binding name, which must be a valid JavaScript variable name.
# This will be how you call (run) your Workflow from within your code.
binding = "MY_WORKFLOW"
 # script_name is required during for the beta.
 # Must match the "name" of your Worker at the top of wrangler.toml
script_name = "my-first-workflow"
...
4. Via the [Workflows REST API]() or [wrangler CLI](/workers/wrangler/commands/#workflows)
